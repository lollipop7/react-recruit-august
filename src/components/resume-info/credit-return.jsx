...
import * as Actions from 'actions';
 ...
 class CreditReturnComponent extends Component {
    ...
    componentDidMount() {
        ...
        const{username, resumeid} = data.resumeInfo;
        if(creditData.flag){
            if(resumeid){
    ...
    render(){
        ...
        if(creditInfoData==null ||(!creditInfoData.cerditcerinfo && !creditInfoData.dishonest && !creditInfoData.education && !creditInfoData.selfinfo && !creditInfoData.basic && !creditInfoData.jzList)){
            Data.push({
                cerditcerinfo:[],
                dishonest:[],
                education:[],
        ...
        return (
            <li style={{width:930}}> 
               { DataObject.selfinfo==null||!DataObject.selfinfo.name?"":
                ...
                >
                    <div>
                        <div className="inverst-item inline-block box-border" style={{width:360,paddingLeft:30}}>
                ...
                {DataObject.basic!=null && <div className="inverst-field" style={{marginBottom:30}}>
                    <div className="inverst-item info-field" style={{width:968}}>
                            <h3 className="title">
                                基本信息
                ...
                <div className="inverst-field">
                    <div className="inverst-item info-field" style={{width:968}}>
                        <h3 className="title" style={{marginBottom:20}}>
                            调查方案查询信息
                        </h3>{DataJzlist.length!=0 ? 
