        ...
        return (
            <div className="questions" >
                ...
                <div style={{width:890,marginLeft:20}}>
                    <h4>问：AI招聘云企业账号是否支持多人登录？</h4>
                    <p>答：AI招聘云针对每个合作企业都会开通一个主账号，同时，每个主账号下面可以创建多个子账号，用于企业内部工作人员进行使用。主账号可以看到各子账号工作进度情况，但是子账号只能看到自己的日常工作情况。</p>
                    
                    <h4>问：AI招聘云内能够直接给用户发送邮件吗？</h4>
                    <p>答：可以的。个人信息中绑定好个人邮箱，通过AI招聘云平台，直接对候选人发送邮件就可以了。</p>
                    
                    <h4>问：在其他平台上发布了职位，收到的候选人简历如何同步到AI招聘云平台内？</h4>
                    ...
                    <p>答：AI招聘云背景调查功能，数据源自于公安局，学信网、最高人民法院等权威机构，依托强大的数据库资源，真实性可以放心。但是不排除个别人员在机构内信息未及时更新导致的错误，调查结果，供企业参考。</p>
                    
                    <h4>问：如何修改密码？</h4>
                    <p>答：AI招聘云工作界面—右上角—修改密码。</p>
